...
const FadeIn = React.forwardRef<any, any>(
...
const ScaleIn = React.forwardRef<any, any>(
...
const AnimateListItem = React.forwardRef<any, any>(
...
const ScrollReveal = React.forwardRef<any, any>(
  ({
    children,
    className,
    direction = 'up',
...
const PressScale = React.forwardRef<any, any>(
...
const FadeOverlay = React.forwardRef<any, any>(
