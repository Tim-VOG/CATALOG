...
const SECTIONS = [
  ...
  { key: 'options', label: 'Options & Plans', icon: SlidersHorizontal },
]

/**
 * ConfigurationTab — Categories + Options & Plans combined in a single tab
 * with a secondary section toggle.
 */
        ...
        {SECTIONS.map((s) => {
          ...
          return (
            ...
            >
              {active && (
                <motion.span
                  layoutId="config-section-toggle"
