...
export function OnboardingRequestPage() {
  ...
  // Auto-suggest email local part: full first name + first letter of last name (only when local is still empty)
  useEffect(() => {
    ...
    setForm((prev) => prev.email_local ? prev : { ...prev, email_local: `${first}${last[0]}` })
