...
export function MyEquipmentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-display font-bold tracking-tight text-foreground">My Equipment</h1>
                          ...
                          <button
                            ...
                            onClick={async () => {
                              const ok = await confirmDialog({
                                ...
                                description: `Report ${loan.product_name} as lost? An admin will be notified.`,
