    ...
    try {
      ...
      sendEmail({
        ...
        body: `<div style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;max-width:520px;margin:0 auto;">
          ...
          <p style="color:#64748b;font-size:15px;">Your <strong>offboarding</strong> request for <strong>${form.name}</strong> has been received and will be processed by the IT team.</p>
