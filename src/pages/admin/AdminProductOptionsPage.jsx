            ...
            {options.map((opt) => (
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  <Button variant="ghost" size="icon" onClick={() => handleToggle(opt)} aria-label={`Toggle ${opt.name}`}>
                  ...
                  <Button variant="ghost" size="icon" onClick={() => openEdit(opt)} aria-label={`Edit ${opt.name}`}>
                    <Pencil className="h-3.5 w-3.5" />
                  </Button>
                  <Button variant="ghost" size="icon" className="text-destructive" onClick={() => handleDelete(opt)} aria-label={`Delete ${opt.name}`}>
          ...
          <div className="space-y-2">
            {plans.map((plan) => (
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  <Button variant="ghost" size="icon" onClick={() => handleToggle(plan)} aria-label={`Toggle ${plan.name}`}>
                  ...
                  <Button variant="ghost" size="icon" onClick={() => openEdit(plan)} aria-label={`Edit ${plan.name}`}>
                    <Pencil className="h-3.5 w-3.5" />
                  </Button>
                  <Button variant="ghost" size="icon" className="text-destructive" onClick={() => handleDelete(plan)} aria-label={`Delete ${plan.name}`}>
                    <Trash2 className="h-3.5 w-3.5" />
                  </Button>
                </div>
              </div>
